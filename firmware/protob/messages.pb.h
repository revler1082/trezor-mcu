...
typedef enum _MessageType {
    ...
    MessageType_MessageType_XmrGetAddress = 64,
    MessageType_MessageType_XmrAddress = 65,
...
typedef struct {
    size_t size;
    uint8_t bytes[106];
} XmrAddress_address_t;

typedef struct _XmrAddress {
    XmrAddress_address_t address;
} XmrAddress;

typedef struct {
    size_t size;
    uint8_t bytes[8];
} XmrGetAddress_payment_id_t;

typedef struct _XmrGetAddress {
    bool has_payment_id;
    XmrGetAddress_payment_id_t payment_id;
    bool has_show_display;
    bool show_display;
} XmrGetAddress;
...
#define XmrGetAddress_init_default               {false, {0, {0}}, false, 0}
#define Address_init_default                     {""}
#define EthereumAddress_init_default             {{0, {0}}}
#define XmrAddress_init_default                  {{0, {0}}}
...
#define XmrGetAddress_init_zero                  {false, {0, {0}}, false, 0}
#define Address_init_zero                        {""}
#define EthereumAddress_init_zero                {{0, {0}}}
#define XmrAddress_init_zero                     {{0, {0}}}
...
#define XmrAddress_address_tag                   1
#define XmrGetAddress_payment_id_tag             1
#define XmrGetAddress_show_display_tag           2
...
extern const pb_field_t XmrGetAddress_fields[3];
extern const pb_field_t Address_fields[2];
extern const pb_field_t EthereumAddress_fields[2];
extern const pb_field_t XmrAddress_fields[2];
...
#define XmrGetAddress_size                       12
#define Address_size                             43
#define EthereumAddress_size                     22
#define XmrAddress_size                          108
